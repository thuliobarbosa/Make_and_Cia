...
/**
 * Servlet implementation class InserirContaPagar
 */
@WebServlet("/InserirContaPagar")
public class InserirContaPagar extends HttpServlet implements Modelo{
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InserirContaPagar() {
        super();
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			String res = gson.toJson(cpDao.inserir(cp));
			out.print(res);
